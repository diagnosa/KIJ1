...
public class DES {
    ...
    public static int[] invIP = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47,
    ...
    public static int[] keyShift = {1, 1, 2, 2, 
                        2, 2, 2, 2,
                        1, 2, 2, 2, 
                        2, 2, 2, 1};
    
    public static int[] expandTbl = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8,
   ...
   /*
    public static void Des(String input){
    ...
    public static byte[] f_func(byte[] R, byte[] K) {
        byte[] tmp;
    ...
    public static byte[] s_func(byte[] in) {
    ...
    public static byte[] encrypt64Bloc(byte[] bloc, byte[][] subkeys, boolean isDecrypt){
    ...
    public static void main(String args[]){
        ...
        String cipherText;
        cipherText = encrypt(plainByte, keyByte);
